...
const ModalNewTask = ({isOpen , onClose , id = null}: Props) => {
    ...
    const selectStyles = "mb-4 block w-full rounded border border-[#3b3d40] px-3 py-2 bg-[#3b3d40] text-white focus:outline-none"
  ...
  return <Modal isOpen={isOpen} onClose={onClose} name='Create New Task'>
    <form className='mt-4 space-y-6' onSubmit={(e)=>{
        ...
        <button type='submit' className={`mt-4 flex w-full justify-center rounded-md border border-transparent bg-[#0275ff] px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-600 hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-600 focus-offset-2
