...
interface SidebarSignOutLinkProps {
  onSignOut: () => void;
  label: string;
  currentUserDetails: any;
}

const SidebarSignOutLink = ({
  onSignOut,
  label,
  currentUserDetails,
}: SidebarSignOutLinkProps) => {
  return (
    <button
      className={`relative flex cursor-pointer items-center gap-3 transition-colors
        bg-black hover:bg-gray-700 justify-start px-8 py-3 w-full`}
      onClick={onSignOut}
      type="button"
    >
